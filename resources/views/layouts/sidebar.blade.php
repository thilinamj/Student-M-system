  ...
  <div class="card-header">Side Bar</div>
    <div class="card-body">
        <div class="list-group-flush">
            ...
            <button type="button" class="list-group-item list-group-item-action "><a href="{{ route('create_course') }}">Manage Course</a></button>
            <button type="button" class="list-group-item list-group-item-action "><a href="{{ route('view_course') }}">View Courses</a></button>
